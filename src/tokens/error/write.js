...
function writeErrorToken(stream: Writer, token: Token) {
  if (!(token instanceof ErrorToken)) {
    throw new Error('Expected instance of ErrorToken');
  }
...
module.exports = writeErrorToken;
